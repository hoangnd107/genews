...
class _SettingsScreenState extends State<SettingsScreen> {
                            ...
                            child: Column(
                              children: [
                                _buildFeedbackTypeOption(
                                  ...
                                  isDarkMode,
                                  () => setModalState(() => selectedFeedbackType = 'Góp ý chung'),
                                ),
                                const SizedBox(height: 12),
                                _buildFeedbackTypeOption(
                                  '🐛',
                                  ...
                                  isDarkMode,
                                  () => setModalState(() => selectedFeedbackType = 'Báo lỗi'),
                                ),
                                const SizedBox(height: 12),
                                _buildFeedbackTypeOption(
                                  '⭐',
                                  ...
                                  isDarkMode,
                                  () => setModalState(() => selectedFeedbackType = 'Đánh giá'),
                                ),
                                const SizedBox(height: 12),
                                _buildFeedbackTypeOption(
                                  '🔧',
                                  ...
                                  selectedFeedbackType == 'Yêu cầu tính năng',
                                  isDarkMode,
                                  () => setModalState(() => selectedFeedbackType = 'Yêu cầu tính năng'),
                                ),
                              ],
                            ),
                          ),
  ...
  void _sendFeedbackEmail(
    ...
    if (subject.trim().isEmpty || message.trim().isEmpty) {
      _showErrorDialog(context, 'Vui lòng điền đầy đủ tiêu đề và nội dung phản hồi.');
      return;
    }
...
''';
    ...
    try {
      if (await canLaunchUrl(emailUri)) {
        ...
        _showErrorDialog(context, 'Không thể mở ứng dụng email. Vui lòng gửi email thủ công đến: nduyhoang107@gmail.com');
      }
    } catch (e) {
      _showErrorDialog(context, 'Có lỗi xảy ra khi gửi email. Vui lòng thử lại sau.');
    }
  }
